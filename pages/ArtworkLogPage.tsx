  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Artwork Log</h1>
          <p className="text-slate-600 text-sm mt-1 font-medium">Centralized creative operations and production tracking.</p>
        </div>
      </header>

      {/* Updated Stats Grid */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard label="Total Artworks" value={stats.totalArtworks} icon="🎨" color="bg-indigo-50 text-indigo-600" />
