               ...
               {submitted && !clarificationRequested ? (
                 ...
                 <form onSubmit={handleSubmitSurvey} className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div className="p-8 space-y-8">
                      {/* NEW EVALUATOR NAME FIELD */}
                      <div className="bg-slate-50 p-6 rounded-xl border border-slate-100">
                        <label className="text-xs font-black text-slate-900 uppercase tracking-wide mb-2 block">
                          Nama Pemberi Evaluasi <span className="text-red-500">*</span>
                        </label>
                        <input
                          type="text"
                          required
                          ...
                          className="w-full p-3 rounded-lg border border-slate-300 text-sm font-bold outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition-all"
                        />
                      </div>
                      ...
                      <button 
                        type="submit" 
                        disabled={submitting || !SURVEY_QUESTIONS.every(q => ratings[q.id] !== undefined) || !evaluatorName.trim()}
